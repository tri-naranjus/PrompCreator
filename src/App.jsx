...
, {
        ...
        body: JSON.stringify({
          contents: [{
            parts: [{ text: `Actua como PROFESIONAL DE INGENIERIA DE PROMPOS. Mejora este prompt para que sea más claro y efectivo pero sin que sea muy largo, mejor conciso que exaustivo:
